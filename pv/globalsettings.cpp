...
const QString GlobalSettings::Key_View_CursorShowFrequency = "View_ShowFrequency";
const QString GlobalSettings::Key_View_CursorShowInterval = "View_ShowInterval";
